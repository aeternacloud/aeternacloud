...
export function Documentation() {
  const docs = [
    { icon: Book, title: 'Getting Started', description: 'Learn the basics and get up to speed quickly' },
    { icon: Code, title: 'API Reference', description: 'Comprehensive API documentation and examples' },
    { icon: FileText, title: 'Guides & Tutorials', description: 'Step-by-step guides for common tasks' },
    { icon: Video, title: 'Video Tutorials', description: 'Visual walkthroughs and demonstrations' },
  ];
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {docs.map((doc, index) => (
              <motion.div
                ...
                className="p-6 bg-white rounded-2xl border border-gray-100 hover:border-[#0052CC]/20 hover:shadow-xl transition-all cursor-pointer"
              >
